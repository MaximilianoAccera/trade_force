...
import src.test.java.pages.App;
import src.test.java.pages.ExtentReports;
import src.test.java.pages.ExtentTest;
import src.test.java.pages.FindFailed;
import util.EvidenceReport;

public class BasePageTF {
	...
	public final Logger logger = Logger.getLogger(BasePageTF.class);
