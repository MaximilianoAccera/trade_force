...
import pages.BasePageTF;
import src.test.java.br.com.cwi.automation_training.util.ExtentTest;
import src.test.java.br.com.cwi.automation_training.util.JSONObject;

public class HttpRequest extends BasePageTF {
